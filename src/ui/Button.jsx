...
function Button({ disabled, children, to, type, onClick }) {
  const base =
    'inline-block text-sm rounded-full bg-teal-600 font-semibold uppercase tracking-wide text-stone-50 transition-colors duration-300 hover:bg-teal-300 focus:outline-none focus:ring focus:ring-teal-300 focus:ring-offset-2 disabled:cursor-not-allowed disabled:bg-stone-300 disabled:text-stone-400';
